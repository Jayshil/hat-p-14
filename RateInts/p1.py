...
for i in range(len(segs)):
    ...
    if not all_completed:
        ...
        jumpstep_results = calwebb_detector1.jump_step.JumpStep.call(linearity_results, rejection_threshold=10., maximum_cores='half', save_results=False)
